...
Std_ReturnType relay_initialize(const relay_t *_relay)
{
    ...
    {
        pin_config_t pin ={.port=_relay->relay_port , .pin=_relay->relay_pin ,.direction =GPIO_DIRECTION_OUTPUT ,.logic=GPIO_LOW};
...
Std_ReturnType relay_turn_on(const relay_t *_relay){
    ...
    {
        pin_config_t pin ={.port=_relay->relay_port , .pin=_relay->relay_pin ,.direction =GPIO_DIRECTION_OUTPUT ,
